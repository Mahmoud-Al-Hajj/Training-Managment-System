...
,p_required_patch=>wwv_flow_imp.id(58103876413563662449)
,p_dialog_chained=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(58103886843612662463)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(58103887265527662464)
,p_name=>'P10011_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(58103886843612662463)
