prompt --application/pages/page_20030
begin
--   Manifest
--     PAGE: 20030
--   Manifest End
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63355800406169310237)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(63355800645295310237)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(63355801244985310238)
,p_name=>'Configuration Options'
...
,p_internal_uid=>63355801244985310238
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355802011857310246)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355802492868310247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355802801630310247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355803275408310247)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355803632477310248)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355804087621310248)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(63355804414021310249)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(63355807237071310251)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'633558073'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'APPLICATION_OPTION:STATUS:DESCRIPTION:UPDATED:UPDATED_BY'
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(63355808711168310253)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(63355800406169310237)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(63355808114759310252)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(63355800645295310237)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(63355809534650310254)
,p_branch_name=>'Branch to Admin Page'
,p_branch_action=>'f?p=&APP_ID.:20100:&APP_SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(63355809171643310253)
...
,p_internal_uid=>63355809171643310253
);
